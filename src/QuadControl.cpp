...
VehicleCommand QuadControl::GenerateMotorCommands(float collThrustCmd, V3F momentCmd)
{
    ...
    float T0 = (-tz+ty+tx+collThrustCmd)/4.0;
    float T1 = (tz+ty-tx+collThrustCmd)/4.0;
    float T2 = (tz-ty+tx+collThrustCmd)/4.0;
    float T3 = (-tz-ty-tx+collThrustCmd)/4.0;
    
     cmd.desiredThrustsN[0] = CONSTRAIN(T0, minMotorThrust, maxMotorThrust);
     cmd.desiredThrustsN[1] = CONSTRAIN(T1, minMotorThrust, maxMotorThrust);
     cmd.desiredThrustsN[2] = CONSTRAIN(T2, minMotorThrust, maxMotorThrust);
     cmd.desiredThrustsN[3] = CONSTRAIN(T3, minMotorThrust, maxMotorThrust);*/
